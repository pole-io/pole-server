...
import (
	...
	"github.com/pole-io/pole-server/pkg/console/internal/observer"
)
...
func (s *stableStore) newStore() {
	s.EventFetcher = &EventFetcher{master: s.master, slave: s.slave}
	s.OperationFetcher = &OperationFetcher{master: s.master, slave: s.slave}
}
