...
func (m *MockCacheManager) RoutingConfig() cache.RoutingConfigCache {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RoutingConfig")
	ret0, _ := ret[0].(cache.RoutingConfigCache)
	return ret0
}
...
// GetRule mocks base method.
func (m *MockRoutingConfigCache) GetRule(id string) *rules.ExtendRouterConfig {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRule", id)
...
func (m *MockRoutingConfigCache) IteratorRouterRule(iterProc cache.RouterRuleIterProc) {
	m.ctrl.T.Helper()
...
func (m *MockRoutingConfigCache) ListRouterRule(service, namespace string) []*rules.ExtendRouterConfig {
	m.ctrl.T.Helper()
...
// QueryRoutingConfigs mocks base method.
func (m *MockRoutingConfigCache) QueryRoutingConfigs(arg0 context.Context, arg1 *cache.RoutingArgs) (uint32, []*rules.ExtendRouterConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryRoutingConfigs", arg0, arg1)
	ret0, _ := ret[0].(uint32)
...
// QueryRoutingConfigs indicates an expected call of QueryRoutingConfigs.
func (mr *MockRoutingConfigCacheMockRecorder) QueryRoutingConfigs(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryRoutingConfigs", reflect.TypeOf((*MockRoutingConfigCache)(nil).QueryRoutingConfigs), arg0, arg1)
}
