...
// Source: ../../../apis/access_control/auth/api.go
...
func (mr *MockStrategyServerMockRecorder) CreateRoles(ctx, reqs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateRoles", reflect.TypeOf((*MockStrategyServer)(nil).CreateRoles), ctx, reqs)
}
...
func (mr *MockStrategyServerMockRecorder) DeleteRoles(ctx, reqs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteRoles", reflect.TypeOf((*MockStrategyServer)(nil).DeleteRoles), ctx, reqs)
}
...
func (mr *MockStrategyServerMockRecorder) GetRoles(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRoles", reflect.TypeOf((*MockStrategyServer)(nil).GetRoles), ctx, query)
}
...
// PolicyHelper mocks base method.
func (m *MockStrategyServer) PolicyHelper() auth.PolicyHelper {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PolicyHelper")
	ret0, _ := ret[0].(auth.PolicyHelper)
	return ret0
}

// PolicyHelper indicates an expected call of PolicyHelper.
func (mr *MockStrategyServerMockRecorder) PolicyHelper() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PolicyHelper", reflect.TypeOf((*MockStrategyServer)(nil).PolicyHelper))
}
...
func (mr *MockStrategyServerMockRecorder) UpdateRoles(ctx, reqs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateRoles", reflect.TypeOf((*MockStrategyServer)(nil).UpdateRoles), ctx, reqs)
}
...
// MockPolicyOperator is a mock of PolicyOperator interface.
type MockPolicyOperator struct {
	ctrl     *gomock.Controller
	recorder *MockPolicyOperatorMockRecorder
}

// MockPolicyOperatorMockRecorder is the mock recorder for MockPolicyOperator.
type MockPolicyOperatorMockRecorder struct {
	mock *MockPolicyOperator
}

// NewMockPolicyOperator creates a new mock instance.
func NewMockPolicyOperator(ctrl *gomock.Controller) *MockPolicyOperator {
	mock := &MockPolicyOperator{ctrl: ctrl}
	mock.recorder = &MockPolicyOperatorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPolicyOperator) EXPECT() *MockPolicyOperatorMockRecorder {
	return m.recorder
}
...
// CreateStrategy indicates an expected call of CreateStrategy.
func (mr *MockPolicyOperatorMockRecorder) CreateStrategy(ctx, strategy interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateStrategy", reflect.TypeOf((*MockPolicyOperator)(nil).CreateStrategy), ctx, strategy)
}
...
// DeleteStrategies indicates an expected call of DeleteStrategies.
func (mr *MockPolicyOperatorMockRecorder) DeleteStrategies(ctx, reqs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteStrategies", reflect.TypeOf((*MockPolicyOperator)(nil).DeleteStrategies), ctx, reqs)
}
...
// GetPrincipalResources indicates an expected call of GetPrincipalResources.
func (mr *MockPolicyOperatorMockRecorder) GetPrincipalResources(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPrincipalResources", reflect.TypeOf((*MockPolicyOperator)(nil).GetPrincipalResources), ctx, query)
}
...
// GetStrategies indicates an expected call of GetStrategies.
func (mr *MockPolicyOperatorMockRecorder) GetStrategies(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStrategies", reflect.TypeOf((*MockPolicyOperator)(nil).GetStrategies), ctx, query)
}
...
// GetStrategy indicates an expected call of GetStrategy.
func (mr *MockPolicyOperatorMockRecorder) GetStrategy(ctx, strategy interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStrategy", reflect.TypeOf((*MockPolicyOperator)(nil).GetStrategy), ctx, strategy)
}
...
// UpdateStrategies indicates an expected call of UpdateStrategies.
func (mr *MockPolicyOperatorMockRecorder) UpdateStrategies(ctx, reqs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateStrategies", reflect.TypeOf((*MockPolicyOperator)(nil).UpdateStrategies), ctx, reqs)
}

// MockRoleOperator is a mock of RoleOperator interface.
type MockRoleOperator struct {
	ctrl     *gomock.Controller
	recorder *MockRoleOperatorMockRecorder
}

// MockRoleOperatorMockRecorder is the mock recorder for MockRoleOperator.
type MockRoleOperatorMockRecorder struct {
	mock *MockRoleOperator
}

// NewMockRoleOperator creates a new mock instance.
func NewMockRoleOperator(ctrl *gomock.Controller) *MockRoleOperator {
	mock := &MockRoleOperator{ctrl: ctrl}
	mock.recorder = &MockRoleOperatorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRoleOperator) EXPECT() *MockRoleOperatorMockRecorder {
	return m.recorder
}
...
// CreateRoles indicates an expected call of CreateRoles.
func (mr *MockRoleOperatorMockRecorder) CreateRoles(ctx, reqs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateRoles", reflect.TypeOf((*MockRoleOperator)(nil).CreateRoles), ctx, reqs)
}
...
// DeleteRoles indicates an expected call of DeleteRoles.
func (mr *MockRoleOperatorMockRecorder) DeleteRoles(ctx, reqs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteRoles", reflect.TypeOf((*MockRoleOperator)(nil).DeleteRoles), ctx, reqs)
}
...
// GetRoles indicates an expected call of GetRoles.
func (mr *MockRoleOperatorMockRecorder) GetRoles(ctx, query interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRoles", reflect.TypeOf((*MockRoleOperator)(nil).GetRoles), ctx, query)
}
...
// UpdateRoles indicates an expected call of UpdateRoles.
func (mr *MockRoleOperatorMockRecorder) UpdateRoles(ctx, reqs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateRoles", reflect.TypeOf((*MockRoleOperator)(nil).UpdateRoles), ctx, reqs)
}
...
// MockPolicyHelper is a mock of PolicyHelper interface.
type MockPolicyHelper struct {
	ctrl     *gomock.Controller
	recorder *MockPolicyHelperMockRecorder
}

// MockPolicyHelperMockRecorder is the mock recorder for MockPolicyHelper.
type MockPolicyHelperMockRecorder struct {
	mock *MockPolicyHelper
}

// NewMockPolicyHelper creates a new mock instance.
func NewMockPolicyHelper(ctrl *gomock.Controller) *MockPolicyHelper {
	mock := &MockPolicyHelper{ctrl: ctrl}
	mock.recorder = &MockPolicyHelperMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockPolicyHelper) EXPECT() *MockPolicyHelperMockRecorder {
	return m.recorder
}

// CleanPrincipal mocks base method.
func (m *MockPolicyHelper) CleanPrincipal(ctx context.Context, tx store.Tx, p auth0.Principal) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanPrincipal", ctx, tx, p)
	ret0, _ := ret[0].(error)
	return ret0
}

// CleanPrincipal indicates an expected call of CleanPrincipal.
func (mr *MockPolicyHelperMockRecorder) CleanPrincipal(ctx, tx, p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CleanPrincipal", reflect.TypeOf((*MockPolicyHelper)(nil).CleanPrincipal), ctx, tx, p)
}

// CreatePrincipalPolicy mocks base method.
func (m *MockPolicyHelper) CreatePrincipalPolicy(ctx context.Context, tx store.Tx, p auth0.Principal) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreatePrincipalPolicy", ctx, tx, p)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreatePrincipalPolicy indicates an expected call of CreatePrincipalPolicy.
func (mr *MockPolicyHelperMockRecorder) CreatePrincipalPolicy(ctx, tx, p interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreatePrincipalPolicy", reflect.TypeOf((*MockPolicyHelper)(nil).CreatePrincipalPolicy), ctx, tx, p)
}

// GetPolicyRule mocks base method.
func (m *MockPolicyHelper) GetPolicyRule(id string) *auth0.StrategyDetail {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPolicyRule", id)
	ret0, _ := ret[0].(*auth0.StrategyDetail)
	return ret0
}

// GetPolicyRule indicates an expected call of GetPolicyRule.
func (mr *MockPolicyHelperMockRecorder) GetPolicyRule(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPolicyRule", reflect.TypeOf((*MockPolicyHelper)(nil).GetPolicyRule), id)
}

// GetRole mocks base method.
func (m *MockPolicyHelper) GetRole(id string) *auth0.Role {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRole", id)
	ret0, _ := ret[0].(*auth0.Role)
	return ret0
}

// GetRole indicates an expected call of GetRole.
func (mr *MockPolicyHelperMockRecorder) GetRole(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRole", reflect.TypeOf((*MockPolicyHelper)(nil).GetRole), id)
}
