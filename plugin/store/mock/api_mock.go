...
func (m *MockStore) DeleteLaneRules(tx store.Tx, group string, ids []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteLaneRules", tx, group, ids)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockStore) LockFaultDetectRule(tx store.Tx, id string) (*rules.FaultDetectRule, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LockFaultDetectRule", tx, id)
	ret0, _ := ret[0].(*rules.FaultDetectRule)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockStoreMockRecorder) LockFaultDetectRule(tx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LockFaultDetectRule", reflect.TypeOf((*MockStore)(nil).LockFaultDetectRule), tx, id)
}
